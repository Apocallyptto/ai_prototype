# tools/submit_test_limit_stale.py
import os
import uuid
...
QTY = float(os.getenv("TEST_QTY", "0.05"))  # fractional
BIAS = float(os.getenv("TEST_LIMIT_BIAS", "-0.50"))  # for BUY: cheaper than ask; adjust if SELL
...
def main():
    ...
    # BUY below market so it stays unfilled (stale)
